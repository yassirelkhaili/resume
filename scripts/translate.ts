...
const translations: Record<Language, Translations> = {
  EN: {
    ...
    project_title3: "Developed an innovative open-source freelance marketplace",
    ...
    project3_skills: "Required Skills: TailwindCSS, Javascript, Typescript, PHP, UML, SQL",
  ...
  project_title3: "Mis au point une place de marché freelance innovante en open-source",
  ...
  project3_skills: "Compétences: TailwindCSS, Javascript, Typescript, PHP, UML, SQL",
  ...
  DE: {
    ...
    project_title3: "Entwickelt einen innovativen Open-Source Freelancer-Marktplatz",
    ...
    project3_skills: "Fähigkeiten: TailwindCSS, Javascript, Typescript, PHP, UML, SQL",
